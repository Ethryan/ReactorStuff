...
public class ItemsRegistry {
	...
	public static void registerItems(RegistryEvent.Register<Item> event){
		event.getRegistry().registerAll(uranium_dust, uranium_ingot, uranium_233_nugget, uranium_233_chunk,
				thorium_crushed, thorium_purified, thorium_dust, thorium_ingot, thorium_nugget, thorium_chunk,
				thorium_fuel, thorium_rod, thorium_rod_dual, thorium_rod_quad, hammer,
				depleted_thorium, depleted_thorium_dual, depleted_thorium_quad,
				isotope_fuel, isotope_rod, isotope_rod_dual, isotope_rod_quad,
				bred_uranium, bred_uranium_dual, bred_uranium_quad,
				triga_fuel, triga_rod, triga_rod_dual, triga_rod_quad,
				depleted_triga, depleted_triga_dual, depleted_triga_quad,
				emerald_dust, beryllium, americium_nugget, americium_chunk, ambe_pellet, ambe_rod,
				elerium_crystal, elerium, elerium_rod, elerium_rod_dual, elerium_rod_quad,
				depleted_elerium, depleted_elerium_dual, depleted_elerium_quad, small_lawrencium, lawrencium,
				gem_blazonium, terminium_rod, terminium_rod_dual, terminium_rod_quad,
				terminium_pick, blazonium_pick, terminium_shovel, terminium_axe, terminium_sword, terminium_hoe,
				blazonium_shovel, blazonium_axe, blazonium_sword, blazonium_hoe, terminium_dust, terminium_ingot,
				terminium_fuel, depleted_terminium_rod, depleted_terminium_rod_dual, depleted_terminium_rod_quad,
				terminium_crushed, terminium_pure, terminium_252_chunk, terminium_252_nugget, terminium_254_chunk,
				terminium_254_nugget, californium_nugget, californium, obsidian_stick,
				blazonium_rod, blazonium_rod_dual, blazonium_rod_quad, blazonium_nugget, blazonium_fuel,
				depleted_blazonium_rod, depleted_blazonium_rod_dual, depleted_blazonium_rod_quad, cfbe_rod, cfbe_pellet);
		event.getRegistry().registerAll(uranium_ore, thorium_ore, elerium_ore, RTG, terminium_ore, blazonium_ore);
	}
